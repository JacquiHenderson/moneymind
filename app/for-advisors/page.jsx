    ...
    <section className="mm-impact-trio" data-screen-label="Adviser impact trio">
      <div className="mm-container">
        <div className="mm-section-head">
          ...
          <p className="lead" style={{ color: 'var(--mm-blue-light)' }}>No behavioral finance degree required — an expert&apos;s read on every client, on tap.</p>
        </div>
...
function AdvisersHowItWorks() {
  return (
    <section className="mm-section hiw" data-screen-label="How it works">
      <div className="mm-container">
        <div className="mm-section-head">
          <span className="eyebrow">How it works</span>
          <h2>MoneyPattern&trade; is your client story, the person behind the plan.</h2>
          <p className="lead">MoneyPattern is the behavioral layer within your advice workflow — revealing the patterns behind client&apos;s financial decisions, so you advise the person, not just the portfolio.</p>
        </div>
    ...
    <section className="mm-section mm-pricing" id="pricing" data-screen-label="Adviser pricing">
      <div className="mm-container">
        <div className="mm-section-head">
          ...
          <h2>One tier. Built for practices.</h2>
          <p className="lead">
...
export default function ForAdvisersPage() {
  return (
    <div className="mm-page">
      ...
      <AdvisersResults />
      <Platform
        heading="MoneyMind's features."
        lead="No behavioral finance degree required — an expert's read on every client, on tap."
      />
      <AdvisersHowItWorks />
      <AdvisersPricing />
      <Steps showCta={false} />
