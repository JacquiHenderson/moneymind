...
export default function TermsOfUsePage() {
  return (
    ...
    >
      ...
      <p>MoneyMind Profile is a workplace tool intended for use by businesses and organizations and not for consumer purposes. Certain provisions of this Agreement apply only to users in specific jurisdictions. These are identified in the relevant clauses and in Schedule 1 (Jurisdiction-Specific Terms).</p>
      ...
      <nav className="lp-toc">
        ...
        <ol>
          ...
          <li><a href="#t-5">Grant of License</a></li>
      ...
      <p>In this Agreement, unless the context otherwise requires, capitalized terms have the meanings set out below:</p>
      <ul>
      ...
      <h2 id="t-5">5. Grant of License</h2>
      <p>Subject to the terms and conditions of this Agreement, we grant to you a <strong>revocable, non-exclusive, non-transferable, non-sublicensable license</strong> to access and use the Software for the Term, solely for your internal business purposes.</p>
      ...
      <p>The Fees are direct debited monthly in advance from your nominated payment method. You may increase or decrease the number of user licenses or change your Subscription Plan via the Manage Account portal; new Fees will apply from the following month with a pro-rata adjustment where necessary.</p>
      ...
      <p>You must not: disassemble, reverse engineer, decompile, modify, or create derivative works of the Software or the Services; rent, lease, lend, sell, transfer, outsource the use of, or grant any rights in the Software/Services to any third party; permit use beyond the number of user licenses in your Subscription Plan; use the Software for any unlawful purpose; attempt to gain unauthorised access to systems or data; interfere with or disrupt integrity or performance; transmit unsolicited communications or spam; stalk, harass, threaten, defame, or harm any person; impersonate any person or entity; upload content that exploits, harms, or threatens children; use automated means (bots, scrapers, crawlers) to access or collect data; circumvent or disable security features; or access the Software from any country subject to comprehensive US, UK, EU, or Australian sanctions.</p>
      ...
      <p>You or your licensors retain ownership of all Intellectual Property Rights in any Material that you upload using the Software or the Services. You grant to us, our employees, contractors, officers, affiliates, and subcontractors a non-exclusive, worldwide, royalty-free, sublicensable (to our service providers solely for the purpose of providing the Services) license to use, reproduce, store, transmit, reformat, display, adapt, and modify your Material solely to the extent necessary to provide, maintain, improve and develop the Services and the Software.</p>
      <h3>Our Intellectual Property</h3>
      <p>We own, or have the necessary grants and licenses to use, all Intellectual Property Rights in the Software and the Services, including all updates, modifications, adaptations, enhancements, and derivatives. Nothing in this Agreement transfers any ownership of such Intellectual Property Rights to you. MoneyMind Profile, and our logos are trademarks of MoneyMind Profile Pty Ltd. You are granted no right or license to use any of our trademarks without our prior written consent. We reserve all rights not expressly granted.</p>
      ...
      <p>Upon termination: you must immediately cease using the Software; you must return or destroy any Confidential Information; all licenses immediately terminate; and you must pay all outstanding Fees within 14 days. 30 days after termination we may permanently delete all copies of your Material; you must export or download your Material before termination if you wish to retain it.</p>
