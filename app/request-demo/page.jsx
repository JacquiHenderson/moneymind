...
const HERO_CHECKS = [
  'Win trust faster and lift advice acceptance',
  'Turn your touchpoints into warm prospects',
  'Cut the time you spend on meeting prep and agendas',
  'Tailor plans to the person behind the numbers',
];
        ...
        <div className="rd-hero-inner">
          <div className="rd-hero-copy">
            ...
            <p className="rd-lede">
              ...
              risk profiling. Get an expert read on every client — no behavioral finance
              degree required. Adapts to your advice workflow. Integrates with your AI
              tools, CRM, and planning software.
            </p>
